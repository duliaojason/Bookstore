...
##### 魏海斌：git仓库搭建，云上实现数据库，数据库搭建，seller功能实现，代码覆盖率测试，报告撰写

##### 廖泽盛：ER图设计，搜索功能实现，数据库搭建，buyer功能实现，代码覆盖率测试，报告撰写

##### 郑智玮：postman测试，testcase（测试接口）编写，数据库搭建，author功能实现，代码覆盖率测试，报告撰写
